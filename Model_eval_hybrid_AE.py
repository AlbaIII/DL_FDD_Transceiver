...
for tap,noise_power_dBm in enumerate(all_noise_power_dBm):
    ...
    learnable_model_savefname = '/home/yangjunyi/BeamformingRevise/Saved Models/MLPAE_{}Dataset_{}Pilot_{}bit_{}dBm_noise.pt'.format(dataset_name, Pilot_num,Feedback_bit,noise_power_dBm)
